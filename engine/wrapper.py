...
class MMIUNet_Wrapper(pl.LightningModule):
    ...
    def __init__(self, args):
        ...
        self.model = MMIUNet_V2(args.bert_type, args.vision_type, args.project_dim, args.model_save_filename) if 'gd' not in args.model_save_filename else MMIUNet_GuideDecoder(args.bert_type, args.vision_type, args.project_dim, args.model_save_filename)
